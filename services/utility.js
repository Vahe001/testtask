    ...
    static generateErrorMessage(type, options) {
        ...
        switch (type) {
            case ErrorTypes.USERNAME_MISSING:
                ...
                break;
            case ErrorTypes.INVALID_ROLE:
                error_object.message = 'You can\'t be admin because admin is already exist.';
                break;
            case ErrorTypes.EMAIL_ALREADY_EXIST:
                error_object.message = 'You can\'t use this email because it\'s use another user.';
                break;
            case ErrorTypes.USERNAME_ALREADY_EXIST:
                error_object.message = 'You can\'t use this username because it\'s use another user.';
                break;
